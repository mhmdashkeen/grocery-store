    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 0, display: "flex", alignItems: 'center', position: { xs: "absolute", md: "static"}, left: { xs: "50%", md: "unset"}, transform: { xs: "translateX(-50%)", md: "none"} }}>
          ...
          {loggedInUser?.isAdmin && <Button
            ...
            </IconButton> : <IconButton aria-label="cart" sx={{color: 'white'}} onClick={() => navigate("/cart")}>
              <ShoppingCartOutlinedIcon />
            </IconButton>}
            {!loggedInUser && <><Button
